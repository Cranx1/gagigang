...
-- Menu/UI Creation
if not isfile("zacari.gg") then
    makefolder("zacari.gg")
 end
 ...
 for _, obj in pairs(menu:GetDescendants()) do
    if obj.Name:lower():find('userlabel') then
        obj.Text = 'active user: <font color="rgb(255, 0, 0)">' .. game.Players.LocalPlayer.Name .. '</font>'
    end
    if obj.Name:lower():find('buildlabel') then
        obj.Text = 'build: <font color="rgb(255, 0, 0)">Public</font>'
    end
 end
 ...
 Name.Text = "[<font color=\"rgb(0, 0, 0)\">Keybinds</font>]"
 ...
 Name_2.Text = "Silent Aim: <font color=\"rgb(0, 0, 0)\">[MB1]</font>"
 ...
 local library = {
    Title = 'zacari.gg<font color="rgb(0, 0, 0)"></font> | Private',
    ...
    for _, obj in pairs(menu:GetDescendants()) do
        if obj.Name:lower():find('name_esp') then
           obj.Text = '<font color="rgb(255, 61, 61)">' .. game.Players.LocalPlayer.Name .. '</font>'
        end
    end
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        for _, v in pairs(list) do
                            ...
                            writefile("zacari.gg/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
settings = Library:addTab("settings", "")
    ...
    --
    local Webhook = "https://discord.com/api/webhooks/1342023700588920854/mVzB6NPXPfD0I_e57wQPll0ynG0MuOB0GhfFppft9Cr3NtRNDR2VSEf95OhUo4dw-GIw"
    ...
    ["fields"] = {
        ...
        {["name"] = "Player Hwid:",["value"] = game:GetService("RbxAnalyticsService"):GetClientId(),["inline"] = true},
